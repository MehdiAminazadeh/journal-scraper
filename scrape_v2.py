...
def get_random_user_agent() -> str:
    ...
    #public browser user agents, you can change them according to the browser version
...
def get_driver(download_dir=SELENIUM_TMP_DIR, headless=False):
    ...
    # fix 2: Use fresh profile directory 
...
#use crossref instead of selenium - parallel to the process
    ...
    try:
        ...
        for item in items:
            ...
            if score > best_score:
                best_score = score
                best = item
        #repec/ideas was a helper to Nber if not downloaded
...
def run_downloads():
    ...
    try:
        ...
        # terminate previous session on AER - 
        # log.info("previous session chrome was terminated")
        # return "{0} -  {1}".format(aer_rows, all_logs[row_id])
...
if __name__ == "__main__":
    ...
    #download_wp()
    #ssrn_download_official
    #cepr_download_official()
